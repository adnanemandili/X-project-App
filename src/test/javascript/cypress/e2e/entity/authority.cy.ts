...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'a0afbf7f-789b-4fc2-bb65-7e2ad9eab0aa' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3670e1e5-9f72-4c64-947b-6772dab0bb78');
      cy.get(`[data-cy="name"]`).should('have.value', '3670e1e5-9f72-4c64-947b-6772dab0bb78');
